    ...
    <>
      <div className="dashboard wrapper">
        <div className="dash_boxes">
          <a href="">
            <div className="dash_box">
              <div className="left">
                ...
                <p className="text_light">Amount Due</p>
              </div>
              <div className="right">
                <svg
                  {...svgAttributes}
          ...
          <a href="">
            <div className="dash_box">
              <div className="left">
                ...
                <p className="text_light">Customers</p>
              </div>
              <div className="right">
                <svg
                  {...svgAttributes}
          ...
          <a href="">
            <div className="dash_box">
              <div className="left">
                <p className="text_focus">1</p>
                <p className="text_light">Invoices</p>
              </div>
              <div className="right">
                <svg
                  {...svgAttributes}
          ...
          <a href="">
            <div className="dash_box">
              <div className="left">
                ...
                <p className="text_light">Estimates</p>
              </div>
              <div className="right">
                <svg
                  {...svgAttributes}
        ...
        <div className="dash_stats">
          <div className="dash_boxes">
            <div className="stats_select">
              <label htmlFor="dateRange">Sales:</label>
              <select id="dateRange">
            ...
            <div className="dash_box">
              <div className="left">
                <p className="text_focus">€ 50,00</p>
                <p className="text_light">Sales</p>
              </div>
              <div className="right">
                <svg
                  {...svgAttributes}
